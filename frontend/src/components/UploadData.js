        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-6">
              <h1>Detect Fraudulent Transactions with Team 404</h1>
              <p>
            ...
            <div className="file-upload">
              <label className="upload" htmlFor="fileInput"></label>
              <input
            ...
            <div className="form-group">
              <button onClick={onUpload} type="button" className="btn btn-primary btn-sm bold-button">
                UPLOAD
              </button>
            </div>
          </div>
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              <h2 className="text-gray-900 text-lg title-font font-medium mb-2 head">
                BigChainDB
              </h2>
              <p className="leading-relaxed text-base para">
        ...
        <section className="text-gray-600 body-font relative">
          ...
          <div className="container px-5 py-24 mx-auto flex">
            <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
              ...
              <div className="relative mb-4">
                <label htmlForS="message" className="leading-7 text-sm text-gray-600">
                  Message
                </label>
                <textarea
                  id="message"
